        ...
        <Layout className="p-8 lg:px-32">
          <div className="flex flex-col items-center w-full lg:flex-row">
            ...
            <div className="w-full flex flex-col lg:w-1/2">
              <h1 className="inline-block w-full text-dark font-bold text-4xl text-center lg:text-left">
                Profile
              </h1>
              <h3 className="inline-block w-full py-2 font-semibold text-gray-700 text-lg text-center lg:text-left">
                Update your profile
              </h3>
